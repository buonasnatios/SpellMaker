...
public class Spell
{
	public Spell(List<IInvocation> invocations, string spellName)
	{
		Invocations = invocations;
		SpellName = spellName;
	}
	
	public Spell(string spellName) : this(new List<IInvocation>(), spellName)
	{
	...
	public List<IInvocation> Invocations { get; set; }
	...
	public List<InvocationType> SpellOrder { get; set; } = new();
	...
	private ElementType? CombineElements(ElementType elementType)
	{
		...
		switch (ElementType)
		{
			case Data.Enums.ElementType.Cold:
				...
				{
					Data.Enums.ElementType.Water => Data.Enums.ElementType.Ice,
					_ => throw new ArgumentOutOfRangeException(nameof(elementType), elementType, null)
				};
			case Data.Enums.ElementType.Earth:
				return elementType switch
				{
					Data.Enums.ElementType.Heat => Data.Enums.ElementType.Lava,
					_ => throw new ArgumentOutOfRangeException(nameof(elementType), elementType, null)
				};
			case Data.Enums.ElementType.Heat:
				return elementType switch
				{
					Data.Enums.ElementType.Earth => Data.Enums.ElementType.Lava,
					Data.Enums.ElementType.Air => Data.Enums.ElementType.Plasma,
					_ => throw new ArgumentOutOfRangeException(nameof(elementType), elementType, null)
				};
			...
			case Data.Enums.ElementType.Air:
				return elementType switch
				{
					Data.Enums.ElementType.Heat => Data.Enums.ElementType.Plasma,
					_ => throw new ArgumentOutOfRangeException(nameof(elementType), elementType, null)
				};
